...
4. Finally, we added another table with the employees elegible for the Mentorship Program who were born between January 1, 1965 and December 31, 1965. The output showed 1549 workers that apply in this program.
...
- In total 72,458 roles will need to be filled as the "silver tsunami" begins to make an impact.
- 
